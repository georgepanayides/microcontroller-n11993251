...
// // Debug: expose last RX byte to main loop for logging (avoid heavy ISR prints)
// volatile uint8_t uart_rx_debug_flag = 0;
// volatile uint8_t uart_rx_debug_val = 0;
...
//     // Record for debug printing in main loop
//     uart_rx_debug_val = rx_data;
//     uart_rx_debug_flag = 1;
// }
